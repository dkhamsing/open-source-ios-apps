...
- [ProtonMail](https://github.com/ProtonMail/ios-mail): Encrypted Email
  ...
  -  `2022`  [`gpl-3.0`](http://choosealicense.com/licenses/gpl-3.0/) `swift` `iphone` `ipad` `dompurify` `afnetworking` `flanimatedimage` 
  -  ☆`1160` 
...
- [Telegram](https://github.com/TelegramMessenger/Telegram-iOS): Send messages with a focus on speed & security
  ...
  -  ☆`3524` 
- [Threema](https://github.com/threema-ch/threema-ios): The Secure Messenger - Secure. Anonymous. Private
  ...
  -  [`agpl-3.0`](http://choosealicense.com/licenses/agpl-3.0/) `swift` `objc` 
...
- [Critical Maps](https://github.com/criticalmaps/criticalmaps-ios): Organise the monthly critical mass movement around the world
  ...
  -  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `swiftui` `combine` `tca` `snapshottesting` 
  -  ☆`143` 
