...
- [IRCCloud](https://github.com/irccloud/ios): IRC client/service
  ...
  -  `2023`  [`apache-2.0`](http://choosealicense.com/licenses/apache-2.0/) `objc` `fastlane` 
  -  ☆`262` 
...
- [LibTerm](https://github.com/ColdGrub1384/LibTerm): Terminal with Python 3.7 and Lua 5.3, supports iOS 13 dark mode and multi window
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `ipad` 
  -  ☆`540` 
## Education 
...
- [Scan Now](https://github.com/WezSieTato/ScanNow): Fast and simple document scanning
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `swiftui` `visionkit` `pdf` `productivity` `ipad` 
  -  ☆`5` 
## Security 
...
- [Authenticator](https://github.com/mattrubin/authenticator): Simple two-factor authentication with a clean UI
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `2fa` 
  -  ☆`778` 
...
- [Critical Maps](https://github.com/criticalmaps/criticalmaps-ios): Organise the monthly critical mass movement around the world
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `swiftui` `combine` `tca` `snapshottesting` 
  -  ☆`193` 
...
- [EU VAT Number - VIES Freelance](https://github.com/bulbousigloo/VIES)
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `iphone` `ipad` 
  -  ☆`8` 
