...
![](https://img.shields.io/badge/Projects-1475-green.svg) ![](https://img.shields.io/badge/Updated-March%2020,%202023-lightgrey.svg)
...
- [MakeItSo](https://github.com/peterfriese/MakeItSo): A clone of Apple's Reminders
  ...
  -  `2023`  [`apache-2.0`](http://choosealicense.com/licenses/apache-2.0/) `swift` `swiftui` `firebase` 
  -  ☆`363` 
...
- [SwiftTermApp](https://github.com/migueldeicaza/SwiftTermApp): Terminal emulator and SSH client
  ...
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swiftui` 
  -  ☆`229` 
## Education 
...
- [Solstice](https://github.com/daneden/Solstice): Tells you how the daylight is changing
  ...
  -  `2023`  [`cc0-1.0`](http://choosealicense.com/licenses/cc0-1.0/) `swift` 
  -  ☆`40` 
...
- [Loadify](https://github.com/VishwaiOSDev/Loadify-iOS): Instant YouTube video downloader
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `swift` `swift5` `download` `youtube` `downloader` 
  -  ☆`10` 
...
- [StateRestorationDemo](https://github.com/shagedorn/StateRestorationDemo): State preservation & restoration APIs
  ...
  -  `2023`  [`bsd-3-clause`](http://choosealicense.com/licenses/bsd-3-clause/) `swift` 
  -  ☆`46` 
...
- [TailorMade](https://github.com/jogboms/tailor_made): Managing a Fashion designer's daily routine
  -  `2023`  [`mit`](http://choosealicense.com/licenses/mit/) `flutter` `dart` 
  -  ☆`291` 
